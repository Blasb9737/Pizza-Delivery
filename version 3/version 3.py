...
imagesAdd = [plain,peperoni,hawaiian,vegetarian,meatlovers,butterChicken,hamCheese,megaMeatlovers,chicken,cheesyGarlic,vegan,periPeri,remove,nothing,nothing,submit]
